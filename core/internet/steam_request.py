...
from ..api.model import SteamOwnerResponse, SteamProfileResponse, SteamAchievementsResponse, SteamGameResponse
from ..api.type import SteamData


class SteamRequest:
    def __init__(self):
        self.owner_url = 'http://api.steampowered.com/IPlayerService/GetOwnedGames/v0001/'
        self.profile_url = 'http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/'
        self.achievement_url = 'http://api.steampowered.com/ISteamUserStats/GetPlayerAchievements/v0001/'
        self.recently_url = 'http://api.steampowered.com/IPlayerService/GetRecentlyPlayedGames/v0001/'
    ...
    async def request_profile(self, data: SteamData) -> SteamProfileResponse:
        ...
        return SteamProfileResponse.model_validate(res.get('response', {}).get('players', [])[0])
